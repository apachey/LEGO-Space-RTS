...
{
    [Test] public void SnapshotFormatSupportsM3ProductionQueues() => Assert.Multiple(() =>
    {
        Assert.That(SnapshotSerializer.FormatVersion,Is.EqualTo(8));
        Assert.That(SnapshotSerializer.SimulationProtocolVersion,Is.EqualTo(6));
