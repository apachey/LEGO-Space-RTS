...
- Rapid Rider is director-accepted via the SOURCE_LOCKED official LEGO 4920
  appearance with one driver; T084 is authorized but remains unstarted. The
  four-passenger adaptation was rejected; optional passenger/cargo visuals are
  deferred and do not change gameplay capacity.
...
- Solar Explorer is director-accepted on 2026-09-24 via the accepted LEGO 7315
  ...
  unit only and remains unstarted.
- Mission Fighter T083 is director-accepted on 2026-09-24 via the official LEGO
...
- MT-201 Ultra-Drill Walker is director-accepted on 2026-09-25 via its
