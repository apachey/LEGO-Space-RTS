...
| Alien Jet | broad swept plate<br>open pilot cavity<br>paired tall lime arches<br>paired short lateral bulb emitters | `Body`, `Accent`, `Tool`, `Glass`, `Signal`, `Neutral` | `ali_black_hull_surface`, `ali_lime_conduit_surface`, `ali_bay_state_signal_atlas` | None required in this faction draft |
...
| ETX Alien Strike | long keel and lime tail blades<br>paired huge crescent lobes<br>central cockpit and forward emitter | `Body`, `Accent`, `Tool`, `Glass`, `Signal`, `Neutral` | `ali_black_hull_surface`, `ali_lime_conduit_surface`, `ali_bay_state_signal_atlas` | None required in this faction draft |
