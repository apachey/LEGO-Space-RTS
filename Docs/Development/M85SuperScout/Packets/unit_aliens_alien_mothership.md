...
- Repeated modules / connection grammar: Main carrier ring, long central/front section, two side bays, two jetpack bays, tail blades and Charge-relay equipment form one unit.
- Source-faithful versus adapted boundary: Source modules are analyzed separately but may not become separate Mothership entities. Training units inside is a proposal, not a locked T082 mechanic.
