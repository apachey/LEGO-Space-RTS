...
|---|---|---|---|---|
| 1195 — Alien Encounter | [LEGO instructions](https://www.lego.com/en-us/service/building-instructions/1195) | [inventory](https://www.bricklink.com/catalogItemInv.asp?S=1195-1) | CANON_VERIFIED_ARCHIVAL | small Martian Aero Skiff source and human field variant |
| 7317 — Aero Tube Hangar | [LEGO instructions](https://www.lego.com/en-us/service/building-instructions/7317) | [inventory](https://www.bricklink.com/catalogItemInv.asp?S=7317-1) | PRIMARY_VERIFIED | Aero Tube, pump, hypersled, station and skiff mechanisms |
...
- `unit.martians.double_hover` — Both are small open Martian utility platforms. Mitigations: Double Hover is a ground scout on two discs; Aero Skiff has an airborne lift mass below its deck. / Double Hover carries only its operator and sensor; Aero Skiff preserves a separate passenger/cargo perch. / Double Hover is symmetric; Aero Skiff uses an intentionally asymmetric skiff deck.
