...
|---|---|---|---|---|
| 7300 — Double Hover | [LEGO instructions](https://www.lego.com/en-us/service/building-instructions/7300) | [inventory](https://www.bricklink.com/catalogItemInv.asp?S=7300-1) | CANON_VERIFIED_ARCHIVAL | paired-hover scout construction |
...
**Silhouette thesis:** A tiny open scout balanced above two clearly separate circular hover pads.

Non-removable identity anchors:

- paired hover discs
- central exposed rider
- upright sensor stalk
