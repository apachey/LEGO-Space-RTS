# Aero Tube Hangar — T082 Super Scout packet
...
- Faction: `Martians`
- Kind: `Infrastructure`
- Gameplay role: Command / major station
...
**Silhouette thesis:** A sprawling active Martian station organized around transparent pneumatic tubes, pumps and docking towers.

Non-removable identity anchors:

- large transparent tube network
- tall pump and docking towers
- visible hypersled handling platforms

- Rejected V1 blind-review code: `S20`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
