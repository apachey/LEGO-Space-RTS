# ETX Defense Node — T082 Super Scout packet

**Stable ID:** `building.ali.etx_defense_node`
...
- Faction: `Aliens`
- Kind: `Infrastructure`
- Gameplay role: Reconfigurable defense
- Authoritative footprint: `Small`
- Source classification: `NEW GAME CONTENT`
- Approved source sets/motifs: 5617, 7692, 7697
...
**Silhouette thesis:** A landed alien attack craft that visibly pivots between low ground-fire and raised air-intercept postures.

Non-removable identity anchors:

- landed swept craft silhouette
- hinged central hardpoint
- bright directional charge channel

- Rejected V1 blind-review code: `S37`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
...
- Semantic part map:
  - Landed swept attack-craft shell — keeps defense low and vehicle-derived — SOURCE_VERIFIED/CANON_DERIVED_ADAPTATION.
  - Hinged central hardpoint — visibly changes Ground Pulse versus Air Lance aim — CANON_DERIVED_ADAPTATION.
  - Directional lime Charge channel and planted cradle — separate active defense from a flying craft — CANON_DERIVED_ADAPTATION.
- Structural load path: A low planted cradle carries the swept shell and routes hardpoint recoil through visible hinges into ground contacts.
- Repeated modules / connection grammar: Common landed shell, central hardpoint, Ground Pulse head, Air Lance head and Charge conduit.
- Source-faithful versus adapted boundary: New defense combines named 5617/7692/7697 craft grammar; no conventional turret tower and no unlabeled averaged fighter.

## E. Material and texture contract

- Geometry must carry:
  - landed swept craft shell
  - central hinged hardpoint
  - planted low cradle and Charge path
...
- Locomotion / operation: Stationary reconfigurable structure.
- Planted/contact rule: Cradle contacts stay planted; reconfiguration and firing are disabled during the canonical downtime/pressure rules.

| Pivot | Parent | Axis/path and rest-to-extreme motion | Presentation driver |
|---|---|---|---|
| `Pivot_HardpointYaw` | Asset_ETXDefenseNode | bounded target-facing yaw | presentation aim |
| `Pivot_HardpointPitch` | Pivot_HardpointYaw | low Ground Pulse to raised Air Lance angle | configuration and presentation aim |
| `Pivot_ShellBrace` | Asset_ETXDefenseNode | landed shell to locked firing stance | construction/reconfiguration state |

- Required beats:
  - Construction lands and braces the craft shell.
  - Idle scan reflects fitted configuration.
  - Attack channels Charge then fires from the hardpoint.
  - Reconfigure powers down and changes posture; damage cannot skip authoritative downtime.
- Animation consumes authoritative state and never decides gameplay timing or results.

## G. Presentation hookups

- Required presentation sockets: `Socket_Selection`, `Socket_Health`, `Socket_Muzzle`, `Socket_Sensor`, `Socket_Surge`, `Socket_AudioWeapon`.
...
- Remaining source/design decisions:
  - A donor proposal must choose the 5617/7692/7697 shell and hardpoint components and show both silhouettes before approval.
