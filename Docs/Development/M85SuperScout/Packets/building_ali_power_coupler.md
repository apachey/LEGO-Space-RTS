# Power Coupler — T082 Super Scout packet

**Stable ID:** `building.ali.power_coupler`
...
**Silhouette thesis:** A small grounded energy node with two opposed curved couplers focusing on a central lime conductor.

Non-removable identity anchors:

- paired opposing black arcs
- thin central lime conductor
- low three-point landing base

- Rejected V1 blind-review code: `S48`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
...
- `building.ali.resonance_core` — Both are small black-lime energy structures. Mitigations: Resonance Core is dominated by a large faceted crystal; Power Coupler has a thin conductor. / Resonance Core uses radial restraint claws; Power Coupler uses two opposing arcs. / Resonance Core reads as storage/charge intensity; Power Coupler reads as directional energy transfer.

## D. Construction contract

- Contract state: `CANON_DERIVED_ADAPTATION`. This is an internally checked draft, not game-director approval.
- Semantic part map:
  - Two opposed curved black couplers — focus energy toward the center — CANON_DERIVED_ADAPTATION.
  - Thin central lime conductor — distinguishes transfer from Crystal storage — CANON_DERIVED_ADAPTATION.
  - Low three-point landing base — grounds the node as landed machinery — SOURCE_VERIFIED/CANON_DERIVED_ADAPTATION.
- Structural load path: Three low supports carry two opposing arcs around a narrow conductor; energy paths remain physically connected to the base.
- Repeated modules / connection grammar: Landing base, paired couplers, central conductor and outbound interfaces.
- Source-faithful versus adapted boundary: New energy structure from 7691/7646 conduits; no generic turbine, reactor tower or free-floating orb.

## E. Material and texture contract

- Geometry must carry:
  - opposed black arcs
  - thin central conductor
  - low three-point base
...
- Planted/contact rule: Three-point base remains planted while couplers articulate above it.

| Pivot | Parent | Axis/path and rest-to-extreme motion | Presentation driver |
|---|---|---|---|
| `Pivot_CouplerLeft` | Asset_PowerCoupler | construction-open to operating focus angle | construction/energy state |
| `Pivot_CouplerRight` | Asset_PowerCoupler | mirrored focus angle | construction/energy state |

- Required beats:
  - Construction plants base and closes couplers.
  - Idle conductor shows bounded active energy.
  - Brownout dims signals and relaxes focus slightly.
  - Damage drops one arc before conductor failure.
- Animation consumes authoritative state and never decides gameplay timing or results.

## G. Presentation hookups

- Required presentation sockets: `Socket_Selection`, `Socket_Health`, `Socket_Energy`, `Socket_CouplerLeft`, `Socket_CouplerRight`, `Socket_AudioOperations`.
...
- Remaining source/design decisions:
  - Exact 7691/7646 donor arcs require a composed-design comparison before production.
