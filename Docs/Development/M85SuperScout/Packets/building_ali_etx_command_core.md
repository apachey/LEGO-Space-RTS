# ETX Command Core — T082 Super Scout packet

**Stable ID:** `building.ali.etx_command_core`
...
**Silhouette thesis:** A grounded mothership segment unfolded into a broad command cradle around a protected resonance core.

Non-removable identity anchors:

- docked-craft radial footprint
- raised central crystal core
- open transformation-seam entrances

- Rejected V1 blind-review code: `S32`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
...
- Semantic part map:
  - Grounded Mothership-derived hull segment — establishes craft-derived command architecture — CANON_DERIVED_ADAPTATION.
  - Raised protected resonance core — creates a clear HQ landmark and technology focus — CANON_DERIVED_ADAPTATION.
  - Open transformation-seam entrances and docking panels — preserve usable circulation — CANON_DERIVED_ADAPTATION.
- Structural load path: A broad landed hull frame transfers the raised core into multiple planted legs while open seams form entrances outside support loads.
- Repeated modules / connection grammar: Command core, radial hull segments, landing legs, Servitor production bay and resource interface remain separate functions.
- Source-faithful versus adapted boundary: New gameplay structure derived from 7691/7646 grammar; it may not be a cut-out literal Mothership or organic hive.
...
- Planted/contact rule: All landing supports remain planted and entrances unobstructed.

| Pivot | Parent | Axis/path and rest-to-extreme motion | Presentation driver |
|---|---|---|---|
| `Pivot_CommandShell` | Asset_ETXCommandCore | landed closed form to open command cradle | construction progress |
| `Pivot_ProductionBay` | Asset_ETXCommandCore | closed rest to Servitor release opening | production progress |

- Required beats:
  - Construction lands, plants and unfolds.
  - Idle signals route toward the raised core.
  - Servitor production opens a clear bay.
  - Damage disables outer panels before core collapse.
...
- Remaining source/design decisions:
  - A donor proposal must distinguish Command Core modules from Mothership and Reconfiguration Dock before modeling.
