# Reconfiguration Dock — T082 Super Scout packet

**Stable ID:** `building.ali.reconfiguration_dock`
...
- Faction: `Aliens`
- Kind: `Infrastructure`
- Gameplay role: Advanced production / transformation
- Authoritative footprint: `Huge`
- Source classification: `NEW GAME CONTENT`
- Approved source sets/motifs: 7646, 7693, 7691
...
**Silhouette thesis:** A huge split-shell dock whose articulated halves hold transforming craft clear of the ground.

Non-removable identity anchors:

- paired tall folding dock shells
- central suspended transformation cradle
- multiple exposed hinge arcs

- Rejected V1 blind-review code: `S17`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
...
- `building.ali.etx_fabricator` — Both are craft-derived Alien production structures. Mitigations: Fabricator is low and forward-open; Reconfiguration Dock is huge and vertically split. / Fabricator moves small craft along one channel; Reconfiguration Dock suspends a transforming craft in a central cradle. / Fabricator uses compact feed arms; Reconfiguration Dock exposes multiple large hinge arcs.

## D. Construction contract

- Contract state: `CANON_DERIVED_ADAPTATION`. This is an internally checked draft, not game-director approval.
- Semantic part map:
  - Two tall split-shell dock halves — frame advanced craft without enclosing them — SOURCE_VERIFIED/CANON_DERIVED_ADAPTATION.
  - Central suspended transformation cradle — carries Strike/Infiltrator load clear of the ground — CANON_DERIVED_ADAPTATION.
  - Multiple exposed hinge arcs and conduits — make assembly and reconfiguration mechanical — SOURCE_VERIFIED/CANON_DERIVED_ADAPTATION.
- Structural load path: Two planted shell towers carry the suspended cradle through visible upper and side braces while leaving one huge exit clear.
- Repeated modules / connection grammar: Split shells, suspension cradle, transformation arms, service conduits and production exit.
- Source-faithful versus adapted boundary: New composite from 7646/7693/7691; exact donor connections must be reviewed and may not copy one unit at building scale.

## E. Material and texture contract

- Geometry must carry:
  - paired tall split shells
  - central suspended cradle
  - visible hinge and conduit network
...
- Planted/contact rule: Both tower bases remain planted; suspended craft never becomes structural support.

| Pivot | Parent | Axis/path and rest-to-extreme motion | Presentation driver |
|---|---|---|---|
| `Pivot_DockShellLeft` | Asset_ReconfigurationDock | closed protection to open service angle | production/repair progress |
| `Pivot_DockShellRight` | Asset_ReconfigurationDock | mirrored open angle | production/repair progress |
| `Pivot_Cradle` | Asset_ReconfigurationDock | vertical receive/service/release path | production progress |

- Required beats:
  - Construction plants towers and opens cradle.
  - Idle leaves exit clear.
  - Production suspends and configures one advanced craft.
  - Damage drops shell outward; destruction releases no unit before authoritative completion.
- Animation consumes authoritative state and never decides gameplay timing or results.

## G. Presentation hookups

- Required presentation sockets: `Socket_Selection`, `Socket_Health`, `Socket_ProductionExit`, `Socket_Cradle`, `Socket_Service`, `Socket_AudioOperations`.
...
- Remaining source/design decisions:
  - The 7646/7693/7691 donor split and full-size exit clearance need director review.
