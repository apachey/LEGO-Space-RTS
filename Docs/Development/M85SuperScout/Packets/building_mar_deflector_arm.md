# Deflector Arm — T082 Super Scout packet

**Stable ID:** `building.mar.deflector_arm`
...
- Faction: `Martians`
- Kind: `Infrastructure`
- Gameplay role: Anti-ground displacement
- Authoritative footprint: `Small`
- Source classification: `NEW GAME CONTENT`
- Approved source sets/motifs: 7313, 7316
...
**Silhouette thesis:** A single huge articulated mechanical arm on a compact planted base, built to push rather than shoot.

Non-removable identity anchors:

- one dominant long arm
- broad pushing paddle
- low multi-foot stabilizer base

- Rejected V1 blind-review code: `S51`. Historical failed boards: [24-cell](../Silhouettes/blind_24_cells.svg), [44-cell](../Silhouettes/blind_44_cells.svg), [72-cell](../Silhouettes/blind_72_cells.svg). The game director recognized 0/66 at 24 cells; this primitive concept is not an approved model or accepted evidence.
...
- Semantic part map:
  - One dominant long articulated arm — makes mechanical displacement the whole silhouette — CANON_DERIVED_ADAPTATION.
  - Broad pushing paddle — communicates deflection rather than gunfire — CANON_DERIVED_ADAPTATION.
  - Low multi-foot stabilizer base — grounds the control force and exposes counterplay — SOURCE_VERIFIED/CANON_DERIVED_ADAPTATION.
- Structural load path: A compact radial planted base routes paddle reaction through a two-stage arm and visible joint braces into several low stabilizer feet.
- Repeated modules / connection grammar: Stabilizer base, shoulder, elbow linkage, broad paddle and pressure feed remain separate functions.
- Source-faithful versus adapted boundary: New gameplay structure extrapolates 7313/7316 arms. It may not acquire a barrel, energy turret silhouette or unsupported telekinetic effect.
...
- Locomotion / operation: Stationary anti-ground positional defense.
- Planted/contact rule: All stabilizer feet remain planted; the arm resets mechanically after each bounded Deflection Pulse.

| Pivot | Parent | Axis/path and rest-to-extreme motion | Presentation driver |
|---|---|---|---|
| `Pivot_DeflectorShoulder` | Asset_DeflectorArm | rest to target-facing swing arc | authoritative deflection attack |
| `Pivot_DeflectorElbow` | Pivot_DeflectorShoulder | folded recovery to paddle extension | authoritative deflection attack |
| `Pivot_Stabilizers` | Asset_DeflectorArm | construction-folded to fully planted stance | construction and operational state |

- Required beats:
  - Construction plants stabilizers before raising the arm.
  - Idle paddle remains visibly physical and lowered.
  - Deflect aims, extends, pushes and fully recovers.
  - Brownout parks the arm; destruction breaks elbow after authoritative failure.
- Animation consumes authoritative state and never decides gameplay timing or results.

## G. Presentation hookups

- Required presentation sockets: `Socket_Selection`, `Socket_Health`, `Socket_DeflectContact`, `Socket_Stability`, `Socket_Energy`, `Socket_AudioMechanism`.
...
- Remaining source/design decisions:
  - Paddle area and arm height need silhouette review against Protector and Searcher tools.
