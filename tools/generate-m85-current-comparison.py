...
<p>Це огляд із назвами, не сліпий тест і не перевірка масштабу в грі. Старі базові картинки залишені лише як контекст, не як автоматично погоджений вигляд. Виправлений MT-101 погоджений для цього порівняльного огляду: зореліт приєднаний позаду, мінібайк прихований усередині, а повний Zamor launcher стоїть окремо над кабіною. Картинка не доводить точність конструкції чи роботу в грі. У Mothership досі не погоджені оператори та рельєф замість друку.</p>
